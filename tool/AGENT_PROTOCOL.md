...
| `generate` | `{ provider, providerProtocol, providerVersion, continuityShot, output, spec }`; `continuityShot` is the selected shot ID or `null` | `generated-media`, `generation-recipe`, `registry` |
