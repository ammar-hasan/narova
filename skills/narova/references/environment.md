...
| native npm packages | Skia frames, OpenType shaping, Urdu/Arabic fallback font | `npm install --prefix <skill-dir>/tool` |
...
The native provider pins `@napi-rs/canvas`, FontKit, and the OFL-licensed Noto
